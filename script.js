...
const questions = [
  {
    ...
    imageUrl:
      "https://www.myfili.com/wp-content/uploads/2025/08/costOfAttendance.png",
    statements: [
  ...
  },
  {
    ...
    imageUrl:
      "https://www.myfili.com/wp-content/uploads/2025/08/inStateTuition.png",
    statements: [
  ...
  },
  {
    ...
    imageUrl:
      "https://www.myfili.com/wp-content/uploads/2025/08/outOfStateTuition.png",
    statements: [
  ...
  },
  {
    term: "Financial aid",
    imageUrl:
      "https://www.myfili.com/wp-content/uploads/2025/08/financialAid.png",
    statements: [
  ...
  },
  {
    term: "Scholarships",
    imageUrl:
      "https://www.myfili.com/wp-content/uploads/2025/08/scholarship.png",
    statements: [
  ...
  },
  {
    ...
    imageUrl:
      "https://www.myfili.com/wp-content/uploads/2025/08/workStudyProgram.png",
    statements: [
  ...
  },
  {
    term: "Student loans",
    imageUrl:
      "https://www.myfili.com/wp-content/uploads/2025/08/studentLoans.png",
    statements: [
  ...
  },
  {
    ...
    imageUrl:
      "https://www.myfili.com/wp-content/uploads/2025/08/scholarshipDatabase.png",
    statements: [
  ...
  },
  {
    ...
    imageUrl:
      "https://www.myfili.com/wp-content/uploads/2025/08/applicationRequirement.png",
    statements: [
  ...
  },
  {
    term: "Award criteria",
    imageUrl:
      "https://www.myfili.com/wp-content/uploads/2025/08/awardCriteria.png",
    statements: [
  ...
  },
  {
    ...
    imageUrl:
      "https://www.myfili.com/wp-content/uploads/2025/08/personalStatement.png",
    statements: [
  ...
  },
  {
    term: "Federal loans",
    imageUrl:
      "https://www.myfili.com/wp-content/uploads/2025/08/federalLoans.png",
    statements: [
  ...
  },
  {
    term: "Private loans",
    imageUrl:
      "https://www.myfili.com/wp-content/uploads/2025/08/privateLoans.png",
    statements: [
  ...
  },
  {
    term: "Interest rate",
    imageUrl:
      "https://www.myfili.com/wp-content/uploads/2025/08/interestRate.png",
    statements: [
  ...
  },
  {
    ...
    imageUrl:
      "https://www.myfili.com/wp-content/uploads/2025/08/repaymentTerms.png",
    statements: [
  ...
  },
  {
    term: "Forbearance",
    imageUrl:
      "https://www.myfili.com/wp-content/uploads/2025/08/forbearance.png",
    statements: [
  ...
  },
  {
    ...
    imageUrl:
      "https://www.myfili.com/wp-content/uploads/2025/08/incomeDrivenRepayment.png",
    statements: [
  ...
  },
  {
    ...
    imageUrl:
      "https://www.myfili.com/wp-content/uploads/2025/08/alternativeEducation.png",
    statements: [
  ...
  },
  {
    term: "Trade schools",
    imageUrl:
      "https://www.myfili.com/wp-content/uploads/2025/08/tradeSchools.png",
    statements: [
  ...
  },
  {
    ...
    imageUrl:
      "https://www.myfili.com/wp-content/uploads/2025/08/Apprenticeship.png",
    statements: [
...

  {
    ...
    imageUrl:
      "https://www.myfili.com/wp-content/uploads/2025/08/communityCollege.png",
    statements: [
  ...
  },
  {
    term: "Accreditation",
    imageUrl:
      "https://www.myfili.com/wp-content/uploads/2025/08/Accreditation.png",
    statements: [
  ...
  },
  {
    ...
    imageUrl:
      "https://www.myfili.com/wp-content/uploads/2025/08/careerCounseling.jpg",
    statements: [
...
function shuffleQuestions(questions) {
  ...
  while (gameTerms.length < 10) {
    // if we have 10 terms already, stop
    let randomNum = Math.floor(Math.random() * questions.length); // generate a random number between 0 and 30
    if (gameTerms.includes(questions[randomNum])) {
      // if the term is already in the gameTerms array, go back to while loop
...
function handleAnswer(userChoice, answerIndex, answerStatement) {
  ...
  if (answerIndex === userChoice) {
    // If they picked the lie correctly, show a "Correct" message in green
